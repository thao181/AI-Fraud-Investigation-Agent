"""
FastAPI service bọc model XGBoost fraud scoring.
Endpoint POST /predict nhận đúng schema giao dịch mà workflow n8n gửi lên,
trả về risk_score/risk_level/risk_indicators có cùng cấu trúc với node
rule-based cũ, để chỉ cần thay Code node bằng HTTP Request node trong n8n.
"""
